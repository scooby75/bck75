...
def stats_away_page():
    ...
    # Cálculo Over 0.5HT
    partidas_com_gol_ht = ultimas_partidas[(ultimas_partidas['HT_Goals_A'] > 0)]
    ...
    # Cálculo Over 0.5FT
    partidas_com_gol_ft = ultimas_partidas[(ultimas_partidas['FT_Goals_A'] > 0)]
    ...
    # Cálculo Over 1.5FT
    partidas_com_gol_15ft = ultimas_partidas[(ultimas_partidas['FT_Goals_A'] > 1)]
    ...
    # Cálculo Over 2.5FT
    partidas_com_gol_25ft = ultimas_partidas[(ultimas_partidas['FT_Goals_A'] > 2)]
